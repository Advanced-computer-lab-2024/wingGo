...
4. **Configure environment variables:**
   ...
   Then updateit to include the following:
   ### AWS S3 Configuration
   - AWS_BUCKET_NAME=acl-bucket-winggo
   - AWS_ACCESS_KEY_ID=AKIAYHJANJZVF5IVLKU3
   - AWS_SECRET_ACCESS_KEY=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
   ...
   - AMADEUS_API_KEY=411qRfxgffK0XMD9fSGok1LWdPx6xesy
   - AMADEUS_API_SECRET=H0G865mGxvoRygF0
